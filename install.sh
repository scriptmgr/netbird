...
NB_AUTH_ISSUER=$(__nb_origin)/realms/$NB_ORG
NB_AUTH_OIDC_CONFIGURATION_ENDPOINT=$(__nb_origin)/realms/$NB_ORG/.well-known/openid-configuration
NB_AUTH_TOKEN_ENDPOINT=$(__nb_origin)/realms/$NB_ORG/protocol/openid-connect/token
